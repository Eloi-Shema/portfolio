    ...
    >
      <div className="max-w-7xl mx-auto px-5 pt-16 md:pt-20">
        ...
        <div className="flex flex-col lg:flex-row lg:justify-between items-center gap-10">
          ...
          <div className="flex flex-row flex-wrap gap-4 md:gap-6 lg:justify-end">
            {CONTACT_LINKS.map(({ label, href, tech }) => {
              ...
              return (
                <Link
                  ...
                  className="flex items-center justify-center p-3 md:p-4 rounded-xl border border-black/10 hover:scale-110 hover:shadow-md backdrop-blur-sm transition-all duration-300 no-underline"
                >
                  {Icon && (
                    <Icon
                      size={25}
        ...
        <div className="mt-16 md:mt-20 py-10 border-t border-black/10 flex gap-2 items-center xs:justify-center md:justify-end text-xs text-black/50">
          <Image
            src={logo}
            alt="Logo"
            width={20}
